...
function ParticipantRegister() {
    ...
    return (
        <>
            ...
            <div className="w-100 bg-primary d-flex flex-column justify-content-center align-items-center" style={{ height: "100vh" }}>
                <Row className="w-100">
                ...
                <Text className="d-flex align-items-center text-white mt-3">
                    <TfiHeadphoneAlt/>
                <span className="ms-2 my-0">Tech Support : +91 9626295434</span></Text>
            </div>
        </>
